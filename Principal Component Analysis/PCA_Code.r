#### PCA to see communities disposition ####
# Load the dataset
...
#### PCA to understand important variables, only soil and air parameters included ####
# Load the dataset
...
summary(pcaplot)
# PCA Analysis
res.pca <- PCA(pcaplot[, 4:12], # Quantitative variables
               scale.unit = TRUE, # Important: Standardize the variables
               graph = FALSE) # Set to TRUE for basic plots
# Print summary of PCA results
summary(res.pca)
