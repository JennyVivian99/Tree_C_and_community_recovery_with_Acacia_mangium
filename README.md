...
For pairwise adonis installation: install_github("pmartinezarbizu/pairwiseAdonis/pairwiseAdonis") 
For Pielou index see https://www.rpubs.com/roalle/mres_2019
For R2evaluation in lmm https://cran.r-project.org/web/packages/MuMIn/MuMIn.pdf
To calculate and see correlations: https://www.sthda.com/english/wiki/correlation-matrix-a-quick-start-guide-to-analyze-format-and-visualize-a-correlation-matrix-using-r-software
